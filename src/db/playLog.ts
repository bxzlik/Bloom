...
/**
 * Журнал прослушиваний — единственное честное хранилище «что и когда слушали».
 *
 ...
 *
 * Изначально писался под «Итоги», но лимит истории в 200 УНИКАЛЬНЫХ треков с
 * вытеснением по давности врал всем, кто считал прослушивания (сиды волны,
 * умная перемешка, статистика профиля): часто слушанный, но давно не звучавший
 * трек вылетал вместе со счётчиком. Поэтому журнал лежит в `src/db/` — слоем
 * ниже фич — и читается через `db/playStats`, общий синхронный агрегат.
 *
