...
/**
 * Секция настроек «YouTube Music» `#ssec-ytmusic`. Настраивать нечего — всё
 * публичное: поиск, страницы, импорт по ссылке и сам поток работают без
 * авторизации. Карточка лишь сообщает, что всё готово.
 */
